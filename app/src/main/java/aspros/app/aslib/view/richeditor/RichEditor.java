...
public class RichEditor extends WebView
{
    ...
    public interface OnDecorationStateListener
    {
        ...
        void onStateChangeListener(String text, List<Type> types,int color,int fontSize);
    }
    ...
    {
        void onSelectionChange(String text);
    }
    ...
    private void selectionCheck(String text)
    {
        if(onSelectionChangeListener!=null)
        {
            onSelectionChangeListener.onSelectionChange(text.replaceFirst(SELECTION_SCHEME, ""));
        }
    }
    ...
    private void stateCheck(String text)
    {
        ...
        String color=state.substring(state.indexOf('(')+1,state.indexOf(')'));
        String[] rgb=StringUtils.split(color," ,");
        int r= Integer.parseInt(rgb[0]);
        int g= Integer.parseInt(rgb[1]);
        int b= Integer.parseInt(rgb[2]);

        int fontSize= Integer.parseInt(state.substring(state.lastIndexOf(',')+1));
        ...
        {
            mDecorationStateListener.onStateChangeListener(state, types,Color.rgb(r,g,b),fontSize);
        }
    }
    ...
    protected class EditorWebViewClient extends WebViewClient
    {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url)
        {
            ...
            else if (TextUtils.indexOf(url, SELECTION_SCHEME) == 0)
            {
                selectionCheck(decode);
                return true;
            }
