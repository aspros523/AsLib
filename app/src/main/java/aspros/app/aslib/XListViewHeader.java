...
public class XListViewHeader extends LinearLayout implements SwipeBackLayout.RefreshListener
{
    ...
    {
        LayoutParams lp = new LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT);        //在这可以改变初始高度
        mContainer = (LinearLayout) LayoutInflater.from(context)
                                                  .inflate(R.layout.view_xlistview_header, null);
        addView(mContainer, lp);
        setGravity(Gravity.TOP);
        headerViewHeight= DensityUtil.dip2px(context,50);
